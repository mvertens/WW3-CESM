...
!/
      ...
      CHARACTER(LEN=512), PARAMETER  :: SWITCHES  = &
                    'F90 NOGRB NC4 PR3 UQ FLX0 LN1 ST4 BT1 DB1 MLIM NL1 TR0 BS0 REF0 IS0 IC4 XX0 WNT1 WNX1 CRT1 CRX1 O0 O' // &
                    '1 O2 O3 O4 O5 O6 O7 O11 MPI DIST' // &
                    ''
!/
      CONTAINS
!/ ------------------------------------------------------------------- /
...
!/ ------------------------------------------------------------------- /
      USE CONSTANTS
!/
      USE W3GDATMD, ONLY: W3SETG, P2MSF, E3DF, US3DF, USSPF
...
!
          NRQMAX = 0 + 12 + 0 + 2+(NOGE(4)-2)*(NOSWLL+1) + 10+4 + &
                   7+6 + 5+5 + 2+2 + 5+0 + NOEXTR
          DO IFJ=1,5
